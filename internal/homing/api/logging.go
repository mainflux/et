...
func (lm *loggingMiddleware) GetAll(ctx context.Context, repo string, pm homing.PageMetadata) (telemetryPage homing.TelemetryPage, err error) {
	...
	return lm.svc.GetAll(ctx, repo, pm)
}
